...
$usuario=write "Nombre del usuario de sistema: "
#Variables, only Change here

New-Item C-BACKUP -Type Directory

$Destination = "C:\C-BACKUP" #Copy the Files to this Location

$Staging = "C:\Users\$usuario\Downloads\Staging"

$ClearStaging = $true # When $true, Staging Dir will be cleared

$Versions = "15" #How many of the last Backups you want to keep

$BackupDirs = "C:\Users\$usuario\Documents" #What Folders you want to backup
...
#"C:\Users\$usuario\OneDrive - Seidl Michael\0-Temp",

#"C:\Users\$usuario\OneDrive - Seidl Michael\0-Temp\Dir2"
